...
public class MicrofonoController {
	...
	public Microfono detail(@PathVariable Long id) {
	 ...
	 @PostMapping("/microfono")
	    ...
	    public Microfono updateMicrofono(@PathVariable Long id, @RequestBody Microfono updatedMicrofono) {
	        return microService.update(id, updatedMicrofono.getName(), updatedMicrofono.getMarca(), updatedMicrofono.getCreatedAt());
	    }
